        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Passionate developer with a strong foundation in computer science and a keen interest in 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Education Section */}
            <Card className={`bg-white/5 border-purple-500/20 backdrop-blur-sm transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <CardHeader>
          ...
          {/* Personal Summary */}
          <Card className={`mt-12 bg-white/5 border-purple-500/20 backdrop-blur-sm transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <CardHeader>
            ...
            <CardContent>
              <div className="text-gray-300 leading-relaxed space-y-4">
                <p>
                  ...
                  cutting-edge fields like AI and blockchain development.
                </p>
                <p>
                  During my internship at NULLCLASS EdTech, I gained valuable experience in blockchain 
                  development, working on real estate NFT DApps and funding management systems. This 
                  experience has strengthened my understanding of decentralized technologies and smart contracts.
                </p>
                <p>
                  I'm particularly interested in creating innovative solutions that bridge traditional web 
                  development with emerging technologies. My goal is to contribute to projects that make 
                  a meaningful impact while continuously learning and growing in this rapidly evolving field.
                </p>
              </div>
            </CardContent>
          </Card>
